...
from mta_chiller_device.custom_types import Alarm, AttributeDetails
...
from tests.mta_chiller.response_data import getsetup_response, socket_data
...
def test_generate_alarms_list():
    ...
    test_alarms: list[Alarm] = [
        {"device_name": "MTA Chiller 1", "alarm_code": "ChillAntifrzAlrCir1"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 1", "alarm_code": "Cmp1Overload"},  # type: ignore[typeddict-item]
    ]
    ...
    test_alarms = [
        {"device_name": "MTA Chiller 1", "alarm_code": "ChillAntifrzAlrCir1"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 1", "alarm_code": "Cmp1Overload"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 2", "alarm_code": "ChillAntifrzAlrCir1"},  # type: ignore[typeddict-item]
    ]
    results = generate_alarms_list(test_alarms, False, attr_details, dev_name)
    assert results == {
    ...
    test_alarms = [
        ...
        {"device_name": "MTA Chiller 1", "alarm_code": "Cmp1Overload"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 2", "alarm_code": "ChillAntifrzAlrCir1"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 2", "alarm_code": "Evap1PumpOverload"},  # type: ignore[typeddict-item]
    ]
    results = generate_alarms_list(test_alarms, False, attr_details, dev_name)
    assert results == {
        "chiller_antifreeze_alarm": True,
    ...
    test_alarms = [
        {"device_name": "MTA Chiller 1", "alarm_code": "ChillAntifrzAlrCir1"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 1", "alarm_code": "Cmp1Overload"},  # type: ignore[typeddict-item]
        {"device_name": "MTA Chiller 2", "alarm_code": "Cmp1Overload"},  # type: ignore[typeddict-item]
    ]
    results = generate_alarms_list(test_alarms, True, attr_details, dev_name)
    assert results == {
...
def manual_test_attributes() -> None:
